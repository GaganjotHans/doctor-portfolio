...
const Services = () => {
  return (
    <section className="services bg-gray-100 p-5 pb-14" id="service">
      <h1 className="text-5xl font-serif font-normal text-center my-10">
        SERVICES
      </h1>
      <Row className="w-full flex justify-center">
        <Col xs={12} md={4} xl={3} className="p-5">
          <Link href={"/services#service-1"}>
            <div className="proj-imgbx">
              <img // eslint-disable-line
                className="lg:h-72 md:h-36 w-full object-cover object-center rounded-md"
                src="/service1.jpeg"
                alt="image of author"
              />
