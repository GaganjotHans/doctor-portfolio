      ...
      <div className="hylo-relief-content w-4/5">
        <div className="info-section left">
          ...
          <div className="info-box lg:w-72" id="box2">
            ...
            <p>
              ...
              Glycerin provides comfort from mild to moderate dry eye symptoms.
            </p>
          </div>
        </div>
        ...
        <div className="info-section right">
          <div className="info-box ml-auto lg:w-72" id="box3">
            ...
            <p>
              An innovative and easy to use multi-use drop bottle amassing over
              450 million worldwide sales and counting.
            </p>
          </div>
